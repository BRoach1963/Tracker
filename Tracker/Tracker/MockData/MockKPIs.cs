...
namespace Tracker.MockData
{
    ...
    {
        public static ObservableCollection<KeyPerformanceIndicator> GetMockKpiData()
        {
            ...
            new KeyPerformanceIndicator
            {
                ...
                Description = "Average time from code committed to code successfully running in production (in days).",
                Value = 5.0,
                TargetValue = 4.0,
                TargetDirection = TargetDirectionEnum.LessOrEqual,
                OnTargetThresholdPercentage = 5.0,
