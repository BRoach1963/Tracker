                    ...
                    Dependencies =
                        new List<ProjectDependency>
                        {
                            ...
                            new ProjectDependency
                            {
                                ...
                                Description = "Dependent on new API endpoints for the app functionalities.",
                                ProjectId = 3
                            }
                        },
                    Risks =
                ...
                new Project
                {
                    ...
                    Milestones =
                        new List<Milestone>
                        {
                            new Milestone
                            {
                                ID = 1, Name = "Infrastructure Assessment Complete",
                    ...
                    Dependencies =
                        new List<ProjectDependency>
                        {
                            ...
                            new ProjectDependency
                            {
                                ...
                                Description = "Selection of cloud provider must be completed before setup.",
                                ProjectId = 4
                            }
                        },
                    Risks =
