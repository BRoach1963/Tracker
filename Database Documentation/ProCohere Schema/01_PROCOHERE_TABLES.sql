-- ============================================================
-- PROCOHERE SCHEMA - PART 1: TABLES, INDEXES, TRIGGERS
-- Version: 1.0
-- Date: 2026-01-17
--
-- Prerequisites:
...
--
-- Run this file FIRST, then run 02_PROCOHERE_RLS_POLICIES.sql
--
-- Notes:
--   - roles and team_members are COMMENTED OUT (already seeded)
...
-- ============================================================
-- 11. GOAL_CATEGORIES (before goals for FK)
-- ============================================================
...
-- ============================================================
-- 34. ACTIVITY_FEED (immutable - no updated_at trigger)
-- ============================================================
...
-- ============================================================
-- 43. AUDIT_LOG (immutable - no updated_at, no is_deleted filter on indexes)
-- ============================================================
...
-- ============================================================
-- END OF PART 1 - Run 02_PROCOHERE_RLS_POLICIES.sql next
-- ============================================================
